...
import { BookOpen, Globe, Users, Clock, Mail, Phone, MapPin } from "lucide-react"
    ...
    return (
        <div className="min-h-screen min-w-screen bg-background text-foreground">
            ...
            <header className="bg-chart-5 text-card-foreground border-b border-border">
                <div className="container px-4 py-6 mx-auto">
                    <div className="text-center">
                        <h1 className="text-3xl font-bold mb-2">Learn Greek with Maria Konstantinou</h1>
                        <p className="text-lg">Professional Online Greek Language Instruction</p>
                    </div>
                </div>
            </header>
            ...
            <main className="w-full py-8  space-y-12">
                ...
                <section aria-labelledby="about-heading">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-lg leading-relaxed mb-6">
                            Hello! I'm Maria, a certified Greek language teacher with over 10 years of experience
                            helping students master the beautiful Greek language. Whether you're a complete beginner or
                            looking to improve your existing skills, I offer personalized online lessons tailored to your
                ...
                {/* Video Section */}
                <section aria-labelledby="video-heading" className="flex justify-center">
                    <iframe
                        id="video-heading"
                        title="vimeo-player"
                ...
                {/* Services Section */}
                <section aria-labelledby="services-heading " className={'bg-chart-4 pt-6 pb-10'}>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                        {[
                            {
                                icon: <BookOpen className="w-8 h-8 mx-auto text-primary mb-2" />,
                ...
                <section aria-labelledby="contact-heading" className="max-w-2xl mx-auto">
                    <Card>
                        <CardHeader className="text-center">
                            ...
                            <CardDescription>
                                Ready to start learning Greek? Send me a message and I'll get back to you within 24 hours.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                ...
                {/* Contact Information */}
                <section aria-labelledby="contact-info-heading" className="max-w-2xl mx-auto">
                            <h1 id="contact-info-heading" className="text-xl">
                                Contact Information
                            </h1>
            ...
            {/* Footer */}
            <footer className="bg-chart-5 text-card-foreground border-t border-border mt-12">
                <div className="container mx-auto px-4 py-6 text-center">
                    <p className="text-muted-foreground">© 2024 Maria Konstantinou - Greek Language Teacher. All rights reserved.</p>
                </div>
            </footer>
        </div>
    )
